...
public final class Constants {
    ...
    public static final class IndexerConstants {
        ...
        public static final double FORWARD_DUTY_CYCLE = -1.0;
    ...
    public static final class TilterConstants {
        ...
        public static final double START_POSITION = 160 / 4.0; // 160 / 4.0 without AMP piece
...
//            motionMagicConfigs.MotionMagicJerk = 0; // Target jerk of 1600 rps/s/s (0.1 seconds)
    ...
    public static final class SwerveConstants {
        ...
        public static final double AUTO_LINEAR_P = 1;
        public static final double AUTO_ROT_P = 2;
